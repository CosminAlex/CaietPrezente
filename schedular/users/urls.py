...
from .views import login, student_details, addstudents, search_student, \
    students, edit_user, addteacher, get_teacher, get_social, \
    list_all_students, student_absente, get_absente, add_absente, get_absente_student, send_email, statisticaGrupe
...
urlpatterns = [
    ...
    url(r'^social$', get_social, name='social'),
    url(r'^social/stistica-grupe$', statisticaGrupe, name='statisticaGrupe'),
