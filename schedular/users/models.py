...
class Grupe(AbstractBaseUser):
    nume_grupa = models.CharField(
        max_length=30, null=True, blank=True,
        verbose_name=ugettext_lazy('nume_grupa'))
    ...
    numar_absente = models.EmailField(
        max_length=255, unique=True, db_index=True, null=True, blank=True,
        verbose_name=ugettext_lazy('total_absente'))
